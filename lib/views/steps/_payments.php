<div class="step-payment-w latepoint-step-content" data-full-amount="<?php echo $booking->full_amount_to_charge(); ?>" data-sub-step="<?php echo $payment_sub_step; ?>" data-default-portion="<?php echo OsBookingHelper::get_default_payment_portion_type($booking); ?>" data-step-name="payment">
    ...
    <?php if ($booking->can_pay_deposit_and_pay_full()) { ?>
        <div class="lp-payment-portions-w">
            <div class="latepoint-step-content-text-centered">
                ...
                <div><?php _e('You can either make a full payment now or pay later.', 'latepoint'); ?></div>
                <div><?php _e('You wont be charged if you choose to pay later.', 'latepoint'); ?></div>
            </div>
            <div class="lp-options lp-options-grid lp-options-grid-three">
                ...
                <div class="lp-option lp-payment-trigger-payment-portion-selector" data-portion="<?php echo LATEPOINT_PAYMENT_PORTION_DEPOSIT; ?>">
                    ...
                    <div class="lp-option-label"><?php _e('Pay Later', 'latepoint'); ?></div>
                </div>
            </div>
        </div>
    <?php } ?>
